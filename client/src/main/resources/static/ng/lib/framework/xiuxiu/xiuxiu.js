...
xiuxiu.lightEditor = xiuxiu.lightEditor
		|| {
			url : "http://open.web.meitu.com/sources/light/PhotoEditor.swf?version=201410201425",
...
xiuxiu.lightPuzzle = xiuxiu.lightPuzzle
		|| {
			url : "http://open.web.meitu.com/sources/puzzle/CollagePlugin.swf?version=201305211645",
...
xiuxiu.richEditor = xiuxiu.richEditor || {
	url : "http://xiuxiu.web.meitu.com/Main.swf?v=2.6.106",
...
xiuxiu.daitoutie = xiuxiu.daitoutie
		|| {
			url : "http://open.web.meitu.com/sources/daitoutie/FacePhoto.swf?version=201304251419",
...
xiuxiu.avatarEditor = xiuxiu.avatarEditor
		|| {
			url : "http://open.web.meitu.com/sources/avatar/avatar.swf?version=201410201414",
...
xiuxiu.batchEditor = xiuxiu.batchEditor
		|| {
			url : "http://xiuxiu.web.meitu.com/plugin/batch/plugin.swf?version=201405281142",
...
xiuxiu.embedSWF = function(b, c, f, m, e) {
	...
	swfobject.embedSWF(a, xiuxiu.container, f, m, g,
			"http://open.web.meitu.com/sources/expressInstall.swf", h, l,
			xiuxiu.attributes);
	xiuxiu.swfs.push({
...
xiuxiu.setLaunchVars = xiuxiu.setFlashvars = function(key, value, id) {
	id = id || xiuxiu.defaultID;
	xiuxiu.flashvars[id] = xiuxiu.flashvars[id] || {};
	if (key == "cropPresets") {
		if (value.constructor == Array) {
			xiuxiu.flashvars[id][key] = encodeURIComponent(xiuxiu.stringify(value))
		} else {
			xiuxiu.flashvars[id][key] = value
		}
	} else {
		if (key == "customMenu") {
			if (value.constructor == Array) {
			...
			if (key == "avatarPreview") {
				if (value.constructor == Object) {
					xiuxiu.flashvars[id][key] = encodeURIComponent(xiuxiu
							.stringify(value))
				} else {
					xiuxiu.flashvars[id][key] = value
				}
	...
	xiuxiu._apiTrack("setLaunchVars_" + key + "_" + typeof (value))
};
