...
(function () {
    ...
    var object = Object, array = Array, regexp = RegExp, date = Date, string = String, number = Number, math = Math,
        Undefined;
     ...
     * @method [math]()
     * @returns Number
     * @short Math related functions are mapped as shortcuts to numbers and are identical. Note that %Number#dblog% provides some special defaults.
     *
     * @set
     *   abs
     *   sin
